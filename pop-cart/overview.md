...
<div class="spec-value">Automated Popcorn Vending Machine</div>
</div>

<div class="spec-row">
<div class="spec-label">Manufacturer</div>
<div class="spec-value">Sweet Robo</div>
</div>
...
<div class="spec-row">
<div class="spec-label">User Interface</div>
<div class="spec-value">Touchscreen display with customer-facing operation</div>
</div>

<div class="spec-row">
<div class="spec-label">Payment Methods</div>
<div class="spec-value">Credit/Debit Card, Cash, Loyalty Credits</div>
</div>
...
<strong>Important</strong>: The Pop Cart requires climate-controlled indoor environments with <strong>non-condensing humidity</strong> - meaning no moisture should condense on machine surfaces. This protects electronics, preserves food products, and prevents corrosion. Consult the <a href="setup.html#site-requirements">Setup section</a> for complete site requirements and detailed humidity specifications.
