...
*Combined manual for team review and editing*
...
![Pop Cart Dispensing Window with Internal Heating Elements](./assets/overview/dispensing_window_internal_mechanism.webp)
...
![Pop Cart Interior Full Side View](./assets/overview/overview_interior_full_view_side.webp)
![Pop Cart Interior Angled View](./assets/overview/overview_interior_full_view_angle.webp)
...
![Dual Popcorn Dispensing Cylinders Labeled A and B](./assets/overview/dual-popcorn-dispensers-interior.webp)
...
![Pop Cart with Shipping Labels and Bubble Wrap](./assets/setup/machine_wrapped_labeled_shipping.webp)
...
![Pop Cart Fully Wrapped in Bubble Wrap](./assets/setup/machine_wrapped_full_coverage.webp)
![Pop Cart Partially Unwrapped](./assets/setup/machine_wrapped_bubble_protection.webp)
...
![Interior Bubble Wrap Packing Material](./assets/setup/setup_packaging_bubble_wrap_roll.webp)
...
![Amish Country Popcorn Blue Variety Package](./assets/maintenance/popcorn-kernels-blue-package-front.webp)
...
![Popcorn Kernel Bag Size Reference](./assets/maintenance/supply_popcorn_kernels_bag.webp)
![Best Before Date Label](./assets/maintenance/popcorn-kernels-best-before-label.webp)
...
![Dispenser Jammed Error Screen](./assets/troubleshooting/error-screen-dispenser-jammed.webp)
...
![Control Board Assembly with Connectors and Wiring](./assets/parts-service/electronics_control_board_assembly.webp)
...
![Stainless Steel Dispensing Chute Assembly](./assets/parts-service/dispensing_chute_stainless_chamber.webp)
![Interior Detail of Dispensing Chamber](./assets/parts-service/dispensing_chamber_interior_detail.webp)
...
![Kernel Hopper Opening with White Rim and Mounting Hardware](./assets/parts-service/kernel_hopper_opening_assembly.webp)
...
![Front Door Lock with Keyhole](./assets/parts-service/door_lock_mechanism_keyhole.webp)
![Door Lock Mechanism Detail with Blue Indicator](./assets/parts-service/parts_door_lock_mechanism_detail.webp)
...
![Close-up of Lock Mechanism with Blue Indicator](./assets/parts-service/parts_door_lock_closeup_indicator.webp)
...
- **Machine Serial Number**: Located on data plate (record here: ______________)
...
- **Warranty Expiration**: ____________
- **Last Service Date**: ____________
- **Next Scheduled Service**: ____________
...
*Note: This is a general reference. Always verify current part numbers with Sweet Robo before ordering.*
...
Use the <strong>Power Switch</strong> to safely isolate the system.
...
Unplug the unit only after switching off the <strong>power switch</strong> (not during operation).
...
*Generated from individual sections on /Users/lightwing/Documents/GitHub/SweetRoboManuals/pop-cart*
