...
## Step 4: Install LED Panels (Optional)

<div class="quick-start-content">

<div class="quick-start-text">

<div style="background: #e6f3ff; border: 1px solid #b3d9ff; border-radius: 8px; padding: 1rem; margin-bottom: 1rem;">
...
<img src="../robo-ice-cream/assets/setup/led-signage-roof.webp" alt="LED signage roof component with illuminated Robo ice cream branding" style="max-height: 200px;" />
<p style="margin-top: 0.5rem; text-align: center; font-style: italic; color: #666;">LED roof panels for enhanced visibility</p>
</div>
...
<div class="quick-start-image">
<img src="../robo-ice-cream/assets/setup/cup-dispenser-installation.webp" alt="Cup dispenser installation showing proper tube placement" style="max-height: 200px;" />
<div style="background: #f0f0f0; border: 2px dashed #ccc; border-radius: 8px; padding: 1rem; text-align: center; color: #666; margin-top: 1rem;">
IMAGE PLACEHOLDER<br>
Loading cups into tubes
</div>
</div>
...
<div class="qr-text">Scan for hardware setup video guide</div>
</div>