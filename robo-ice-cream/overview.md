...
![External Components Overview](../.gitbook/assets/external-components.webp)
...
![Internal Components Overview](../.gitbook/assets/internal-components.jpg)
...
| ---------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Ice Cream Hoppers      | <p><strong>2 hoppers</strong> (Left &#x26; Right) - 2L minimum, 12L maximum capacity each<br><strong>Important:</strong> Never fill above the air valve (airpath) inside each hopper</p> |
